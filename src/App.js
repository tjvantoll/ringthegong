...
import { getSaleInfo, getSaleId, getGongWatcher } from "./services/data";
...
function App() {
  ...
  const [emoji, setEmoji] = React.useState(pickRandomEmoji);
  const [user, setUser] = React.useState("Anonymous " + chance.animal());
